...
3. Developed my prompt engineering skills through writing prompts to smaller LLMs such as Llama 2.

4. Practiced semantic clustering by using Blue (an algorithm that evaluates similarity between text)

Tools/technologies used: Python (including Pandas), Jupyter Notebooks, AWS Sagemaker, OpenAI API, HuggingFace API, Bleu 


### Next Steps

Computing entropy and evaluating results
